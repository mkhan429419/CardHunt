  ...
  const flashcards = [
    {
      id: 1,
      back: "React",
      front: "A JavaScript library for building user interfaces.",
    },
    {
      id: 2,
      back: "Tailwind CSS",
      front: "A utility-first CSS framework for rapid UI development.",
    },
    {
      id: 3,
      back: "Next.js",
      front: "A React framework for building modern web applications.",
    },
    {
      id: 4,
      back: "TypeScript",
