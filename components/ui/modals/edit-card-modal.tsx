...
const EditCardModal: React.FC<ModalProps> = ({ visible, setVisible, children }) => {
  return (
      ...
      <Dialog onClose={() => setVisible(false)} static={true} open={visible}>
        ...
        >
          <div className='fixed inset-0 z-50 flex items-center justify-center'>
            <Dialog.Panel className='relative h-full w-full max-w-[1500px] flex bg-white rounded-sm shadow-md'>
